...
SECRET_KEY = 'django-insecure-3fchya2k7qh$%+be$z4r7x1ium6*&kt#5ds#f9a=si=u7y+lor'
...
INSTALLED_APPS = [
    ...
    'fileUploader',  # Replace with the actual name of your Django app
    'rest_framework',
]
